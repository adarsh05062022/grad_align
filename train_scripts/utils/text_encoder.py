...
if __name__ == "__main__":
    ...
    print(all_embeddings.shape) # torch.Size([49408, 768])
    text = ["a photo of a cat"]

    input_ids = tokenizer(text, return_tensors="pt").input_ids
    # reverse text given the input_ids
    reverse_text = tokenizer.decode(input_ids[0], skip_special_tokens=True)
    print(reverse_text) # a photo of a cat
    orig_prompt_len = input_ids.shape[1]
    print(input_ids) # tensor([[49406,   320,  1125,   539,   320,  2368, 49407]])
    ...
    print(input_embeds.shape) # torch.Size([7, 768])
    ...
    print(new_input_ids) # tensor([[49406,   320,  1125,   539,   320,  2368,     0,     0,     0,     0, 0, 49407]])
    print(new_embeddings.shape) # torch.Size([12, 768])
