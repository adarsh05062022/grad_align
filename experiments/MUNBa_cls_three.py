...
TEXT_SOMETHING = "layer_importance_masking_50_precent_forget_80_percent_retain_mask"
...
def MUNBa(
    ...
    percent_retain=0.5,  # bottom 30% of gradients for retain importance (low importance allowed to be forgotten
    )
