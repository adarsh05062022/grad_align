...
TEXT_SOMETHING = "layer_importance_masking_20_precent_forget_50_percent_retain_mask_updated"
...
def MUNBa(
    ...
    percent_retain=0.5,  # bottom 50% of gradients for retain importance (low importance allowed to be forgotten
    )
            ...
            for i, (forget_images, forget_labels) in enumerate(forget_dl):   
                ...
                if args.munba:
                    ...
                    for layer_index, (gr, gf, p) in enumerate(zip(grads_r, grads_f, parameters)):
                        ...
                        g_tilde[mask] = alpha_r_l * gr[mask] + alpha_f_l * gf[mask]
