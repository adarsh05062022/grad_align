...
TEXT_SOMETHING = "layer_importance_masking_20_precent_forget_50_percent_retain_per_epoch_mask_fisher_once_nash"
...
def compute_dual_importance_mask(
    ...
    for forget_images, forget_labels in tqdm(forget_dl):
        ...
        # ---- FREE MEMORY ----
        del forget_input, pseudo_input
        del forget_emb, pseudo_emb
        del forget_out, pseudo_out
        del loss_f, loss_r
        del grads_f, grads_r
