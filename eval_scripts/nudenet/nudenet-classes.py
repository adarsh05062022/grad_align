...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--folder", help="folder path to images", type=str, required=False ,default = "/storage/s25017/MUNBa/SD/eval_scripts/CLASS/I2p/diffusers-nsfw-MUNBa-method_full-lr_1e-05_E20_U1000_nudity-epoch_14.pt"
    )
    parser.add_argument(
        "--prompts_path",
        ...
        type=str,
        required=False,
        default="/storage/s25017/MUNBa/SD/prompts/unsafe-prompts4703.csv",
    )
    parser.add_argument(
        "--save_path",
        help="path to csv file with prompts",
        type=str,
        required=False,
        default="/storage/s25017/MUNBa/SD/eval_scripts/nudenet_results.csv",
    )
    parser.add_argument(
        "--threshold",
