...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoints_txt", type=str, required=False, default="/storage/s25017/MUNBa/SD/eval_scripts/CLASS/checkpoints_to_evaluate.txt")
    parser.add_argument("--prompts_path", type=str, required=False, default="/storage/s25017/MUNBa/SD/eval_scripts/CLASS/prompts.csv")
