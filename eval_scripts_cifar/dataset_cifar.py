...
class CIFAR10Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # randomize label for forgotten class
...
def setup_fid_data(class_to_forget, path, image_size, interpolation="bicubic"):
    ...
    train_set = CIFAR10Dataset("train", transform=transform)
    ...
    fake_set = Fake_CIFAR(path, class_to_forget, transform=transform)
